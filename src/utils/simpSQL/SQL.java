package utils.simpSQL;




import utils.simpSQL.Helper.Marker;
import utils.simpSQL.Helper.SQLHelper;
import utils.simpSQL.connection.ConnectionPool;
...
public class SQL {
    ...
    未完成的设计
     */
    private HashMap<String,PreparedStatement> sqlMap = null;
    /*
    从PreparedStatement语句到eSQLType类型的映射
     */
    private HashMap<PreparedStatement, eSQLType> registerMap = null;
    /*
    从PreparedStatement语句到ResultSet对象的映射
     */
    private HashMap<PreparedStatement, ResultSet> resultMap = null;
